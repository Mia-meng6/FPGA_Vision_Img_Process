...
(
    ...
    (* noprune *)output  reg             cfg_done        //寄存器配置完成
);
...
//parameter define
parameter   REG_NUM         =   8'd255      ;   //总共需要配置的寄存器个数
...
assign  cfg_data_reg[159]  =       {16'h5480, 8'h01};  // Gamma enable

// 提亮暗区的 Gamma 曲线
assign  cfg_data_reg[160]  =       {16'h5481, 8'h10};  // 
assign  cfg_data_reg[161]  =       {16'h5482, 8'h1e};  // 
assign  cfg_data_reg[162]  =       {16'h5483, 8'h35};  // 
assign  cfg_data_reg[163]  =       {16'h5484, 8'h55};  // 
assign  cfg_data_reg[164]  =       {16'h5485, 8'h68};  // 
assign  cfg_data_reg[165]  =       {16'h5486, 8'h76};  // 
assign  cfg_data_reg[166]  =       {16'h5487, 8'h82};  // 
assign  cfg_data_reg[167]  =       {16'h5488, 8'h8c};  //
assign  cfg_data_reg[168]  =       {16'h5489, 8'h95};  // 
assign  cfg_data_reg[169]  =       {16'h548a, 8'h9e};  // 

assign  cfg_data_reg[170]  =       {16'h548b, 8'hae};  // 
assign  cfg_data_reg[171]  =       {16'h548c, 8'hbc};  // 
assign  cfg_data_reg[172]  =       {16'h548d, 8'hcf};  // 
assign  cfg_data_reg[173]  =       {16'h548e, 8'hdf};  // 
assign  cfg_data_reg[174]  =       {16'h548f, 8'hec};  // 
...
assign  cfg_data_reg[188]  =       {16'h5583, 8'h60};  // 
assign  cfg_data_reg[189]  =       {16'h5584, 8'h20};  // 
...
// ========== ISP 暗区优化配置 ==========
assign  cfg_data_reg[251]  = {16'h4000, 8'h01};   // 
assign  cfg_data_reg[252]  = {16'h5304, 8'h10};   // 
assign  cfg_data_reg[253]  = {16'h5305, 8'h50};   // 
assign  cfg_data_reg[254]  = {16'h5584, 8'h40};   // 
