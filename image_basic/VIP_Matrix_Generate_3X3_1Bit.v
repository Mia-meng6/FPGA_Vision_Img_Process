...
#(
	parameter	[9:0]	IMG_HDISP = 10'd320,	//320*240
...
(
    .clock		(clk),          // ����ʱ��
    .shiftin	(row3_data),        // ���� shiftin [0:0]
    .shiftout	(),  // ��� shiftout [0:0]
    .clken		(shift_clk_en),  	        // ����ʹ���ź�
    .taps 		({row1_data,row2_data})	// ��� taps [1:0]
);
