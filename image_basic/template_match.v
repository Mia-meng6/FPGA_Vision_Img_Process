...
// 逐模板比较状态机
// -------------------------------------------------------
reg [2:0]  tmpl_idx;       // 当前比较模板索引
reg        comparing;      // 比较进行中
reg [GRID_CELLS-1:0] feat_latch; // 锁存特征向量

reg [2:0]  best_id_r;
reg [7:0]  best_sc_r;

// 汉明距离计算：XNOR 后计 1 的个数
wire [GRID_CELLS-1:0] match_bits = feat_latch ~^ tmpl_rom[tmpl_idx]; // XNOR

// 用函数统计 1 的个数（popcount）
