...
// Description   : SDRAM 主控制状态机 (SDRAM Controller FSM)
//                 仲裁初始化/刷新/读/写四类请求，翻译为 SDRAM 总线命令序列
//   Arbitration Priority: 初始化 > 自动刷新 > 写 > 读
//   Command Encoding    : {CS_n, RAS_n, CAS_n, WE_n} = 4'b (ACTIVE=0011, READ=0101, WRITE=0100, ...)
//   Supported           : CAS Latency=3, Burst Length configurable, Auto Precharge
//   Clock Domain        : sys_clk (100MHz)
//   Target SDRAM        : 16-bit SDR SDRAM, 4-Bank, Row=13bit, Col=9bit
// 
// Revision      : V1.0
// Additional Comments:
// 
